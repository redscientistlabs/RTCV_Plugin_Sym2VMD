...
namespace RTCV_Plugin_Sym2VMD
{
    ...
    public class RTCV_Plugin_Sym2VMD : IPlugin, IDisposable
    {
        //-------[ Plugin metadata ]-------
        ...
        public string Name => nameof(RTCV_Plugin_Sym2VMD).Replace("_"," ");
        ...
        public bool Stop()
        {
            if (RTCV_Plugin_Sym2VMD.CurrentSide == RTCSide.Client && !S.ISNULL<PluginForm>() && !S.GET<PluginForm>().IsDisposed)
            {
